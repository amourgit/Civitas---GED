...
export const SocialLinks: React.FC<SocialLinksProps> = ({
  links,
  showOnMobile = true,
  floatingButtonColor = "bg-slate-800/90",
}) => {
              ...
              >
                <a
                  ...
                  className="flex items-center justify-between w-44 h-14 px-4 ml-[-120px]
                             ...
                             rounded-r-xl relative overflow-hidden border border-white/20
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-1/2 -translate-y-1/2 right-16
                      ...
                      {style.label}
                      <div className="absolute top-1/2 -translate-y-1/2 -right-1 w-2 h-2 bg-slate-900 rotate-45 border-r border-t border-white/20" />
                    </div>
                  </a>
                );
              })}
