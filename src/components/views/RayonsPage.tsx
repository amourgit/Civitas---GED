              ...
              <div className="relative z-10 flex flex-col justify-between h-full">
                <div>
                  ...
                  <div className="flex items-center justify-between mb-2 sm:mb-2.5 md:mb-3">
                    ...
                    <span className="px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg bg-black/35 border border-white/20 text-[9px] sm:text-[10px] font-mono text-white/90 backdrop-blur-md">
                      {rayon.material}
                    </span>
                  </div>
                  ...
                  {/* Metrics with clean glass plate */}
                  <div className="grid grid-cols-2 gap-1.5 sm:gap-2 md:gap-2.5 mt-2.5 sm:mt-3.5 md:mt-4 p-2 sm:p-2.5 md:p-3 rounded-lg sm:rounded-xl bg-black/35 backdrop-blur-md border border-white/15 text-[10px] sm:text-[11px] md:text-xs font-mono text-white">
                    <div className="flex flex-col">
                      <span className="text-white/70 text-[9px] sm:text-[10px] md:text-[11px]">Casiers</span>
                      <span className="text-white font-semibold mt-0.5">{rayon.casierCount} unités</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-white/70 text-[9px] sm:text-[10px] md:text-[11px]">Total documents</span>
